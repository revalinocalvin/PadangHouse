...
public class MenuInteractionV2 : MonoBehaviour
{
    private GameObject heldObject;
    private PlayerInteractionV3 playerInteractionV3;
    //private ObjectSpawner objectSpawner;

    private void Start()
    {
        playerInteractionV3 = FindObjectOfType<PlayerInteractionV3>();
    ...
    public void Interact(GameObject Player)
    {
        ...
        foreach (Collider2D collider in colliders)
        {
            if (collider.CompareTag("Menu Dish"))
            {
                ...
                playerInteractionV3.PickUpObject(gameObject);
                return;
            }
